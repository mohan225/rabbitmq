...
-dialyzer({nowarn_function, 'yeccpars2_422_\'COMMA\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_422_\'COMMA\''/1}).
...
-dialyzer({nowarn_function, 'yeccpars2_422_\'RBRKT\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_422_\'RBRKT\''/1}).
-file("megaco_text_parser_v1.yrl", 1019).
...
-dialyzer({nowarn_function, 'yeccpars2_575_\'COMMA\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_575_\'COMMA\''/1}).
...
-dialyzer({nowarn_function, 'yeccpars2_575_\'RBRKT\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_575_\'RBRKT\''/1}).
-file("megaco_text_parser_v1.yrl", 917).
...
-dialyzer({nowarn_function, 'yeccpars2_592_\'COMMA\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_592_\'COMMA\''/1}).
...
-dialyzer({nowarn_function, 'yeccpars2_592_\'RBRKT\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_592_\'RBRKT\''/1}).
-file("megaco_text_parser_v1.yrl", 961).
