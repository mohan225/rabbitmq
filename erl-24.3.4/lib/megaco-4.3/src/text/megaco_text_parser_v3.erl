...
-dialyzer({nowarn_function, 'yeccpars2_251_\'COMMA\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_251_\'COMMA\''/1}).
...
-dialyzer({nowarn_function, 'yeccpars2_251_\'RBRKT\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_251_\'RBRKT\''/1}).
-file("megaco_text_parser_v3.yrl", 1339).
...
-dialyzer({nowarn_function, 'yeccpars2_438_\'COMMA\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_438_\'COMMA\''/1}).
-file("megaco_text_parser_v3.yrl", 792).
...
-dialyzer({nowarn_function, 'yeccpars2_438_\'RBRKT\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_438_\'RBRKT\''/1}).
-file("megaco_text_parser_v3.yrl", 792).
...
-dialyzer({nowarn_function, 'yeccpars2_730_\'COMMA\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_730_\'COMMA\''/1}).
...
-dialyzer({nowarn_function, 'yeccpars2_730_\'RBRKT\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_730_\'RBRKT\''/1}).
-file("megaco_text_parser_v3.yrl", 1233).
...
-dialyzer({nowarn_function, 'yeccpars2_756_\'COMMA\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_756_\'COMMA\''/1}).
...
-dialyzer({nowarn_function, 'yeccpars2_756_\'RBRKT\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_756_\'RBRKT\''/1}).
-file("megaco_text_parser_v3.yrl", 1273).
