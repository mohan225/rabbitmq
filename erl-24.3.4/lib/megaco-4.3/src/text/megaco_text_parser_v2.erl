...
-dialyzer({nowarn_function, 'yeccpars2_273_\'COMMA\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_273_\'COMMA\''/1}).
...
-dialyzer({nowarn_function, 'yeccpars2_273_\'RBRKT\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_273_\'RBRKT\''/1}).
-file("megaco_text_parser_v2.yrl", 1192).
...
-dialyzer({nowarn_function, 'yeccpars2_415_\'COMMA\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_415_\'COMMA\''/1}).
-file("megaco_text_parser_v2.yrl", 704).
...
-dialyzer({nowarn_function, 'yeccpars2_415_\'RBRKT\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_415_\'RBRKT\''/1}).
-file("megaco_text_parser_v2.yrl", 704).
...
-dialyzer({nowarn_function, 'yeccpars2_421_\'COMMA\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_421_\'COMMA\''/1}).
...
-dialyzer({nowarn_function, 'yeccpars2_421_\'RBRKT\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_421_\'RBRKT\''/1}).
-file("megaco_text_parser_v2.yrl", 1339).
...
-dialyzer({nowarn_function, 'yeccpars2_660_\'COMMA\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_660_\'COMMA\''/1}).
...
-dialyzer({nowarn_function, 'yeccpars2_660_\'RBRKT\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_660_\'RBRKT\''/1}).
-file("megaco_text_parser_v2.yrl", 1097).
...
-dialyzer({nowarn_function, 'yeccpars2_677_\'COMMA\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_677_\'COMMA\''/1}).
...
-dialyzer({nowarn_function, 'yeccpars2_677_\'RBRKT\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_677_\'RBRKT\''/1}).
-file("megaco_text_parser_v2.yrl", 1135).
