...
-dialyzer({nowarn_function, 'yeccpars2_2_\'of\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_2_\'of\''/1}).
-file("xref_parser.yrl", 63).
...
-dialyzer({nowarn_function, 'yeccpars2_6_\'of\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_6_\'of\''/1}).
-file("xref_parser.yrl", 102).
...
-dialyzer({nowarn_function, 'yeccpars2_10_\'of\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_10_\'of\''/1}).
-file("xref_parser.yrl", 79).
...
-dialyzer({nowarn_function, 'yeccpars2_38_\'of\''/1}).
-compile({nowarn_unused_function,  'yeccpars2_38_\'of\''/1}).
-file("xref_parser.yrl", 63).
